 ...
 data(){
     return{
         ...
         form:{
              ...
              required:this.feetype.required,
              rule:this.feetype.rule
         },
     ...
     async submit(){
       if(this.$refs.form.validate())
       {
          this.valid = true
          this.loading=true
          const data ={id:this.feetype.id,data:this.form}
          this.$store.dispatch('tenderfeetype/updateFeetype',data)
          this.loading=false
