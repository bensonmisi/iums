              ...
              <v-card>
                  <v-card-text class="d-flex">
                      <v-btn text to="dashboard">Dashboard</v-btn>
                       <v-btn text disabled>Procurement Class</v-btn>
                  </v-card-text>
              </v-card>
          </v-col>
      </v-row>
                 ...
                 <v-simple-table>
                    ...
                    <tbody>
                        ...
                        <td class="d-flex justify-end pt-2 pb-2">
                            <ProcurementclassEdit :item="per"/>
                            <ProcurementclassDelete :item="per"/>
                            <ProcurementthresholdView :item="per"/>
                        </td>
                        </tr>
                        </template>
                        <template v-else>
...
<script>
import procurementthreshold from './procurementthreshold.vue'
export default {
  components: { procurementthreshold },
layout:'user',
data(){
    return{
        overlay:false
